// -----------------------------------------------------------------------------
// apb_timer_env_cfg.svh : top-level configuration object for the timer env.
...
// -----------------------------------------------------------------------------
`ifndef APB_TIMER_ENV_CFG_SVH
`define APB_TIMER_ENV_CFG_SVH

class apb_timer_env_cfg extends uvm_object;
  `uvm_object_utils(apb_timer_env_cfg)
  ...
  function new(string name = "apb_timer_env_cfg");
    super.new(name);
  endfunction

endclass

`endif // APB_TIMER_ENV_CFG_SVH
